  ...
  },
  {
    ...
    match: (relativePath) =>
      ...
      basenameIsOneOf(relativePath, [
        ...
        "web-control-plane-fuzz.test.ts",
    ...
    match: (relativePath) =>
      relativePath.startsWith("web/") && (
        basenameIsOneOf(relativePath, [
          ...
          "editor-caret-css.test.ts",
          "editor-extension.test.ts",
          "editor-file-reference.test.ts",
          "editor-paste-image.test.ts",
          "editor-popout-transfer.test.ts",
          "editor-safety.test.ts",
          "editor-search-reveal.test.ts",
          ...
          "image-annotator.test.ts",
          "markdown-live-preview-gating.test.ts",
          "markdown-live-preview-parity.test.ts",
          ...
          "post-self-continuation.test.ts",

...
async function main() {
  ...
  const currentWebDistDir = resolve(repoRoot, 'runtime', 'web', 'static', 'mobile', 'dist');
  const containerWebDistDir = '/usr/local/lib/bun/install/global/node_modules/piclaw/runtime/web/static/mobile/dist';

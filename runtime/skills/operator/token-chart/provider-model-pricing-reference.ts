...
const PRICING_RULES: ProviderModelPricingRule[] = [
  ...
  {
    id: "minimax-m2.7",
    models: ["minimax-m2.7", "minimax-m2p7", "minimax/minimax-m2.7"],
    canonicalModel: "MiniMax M2.7",
    basis: "MiniMax official PAYG pricing docs + OpenRouter provider row, accessed 2026-05-25",
    inputPerMTok: 0.3,
    outputPerMTok: 1.2,
    cacheReadPerMTok: 0.06,
    cacheWritePerMTok: 0.375,
    notes: "Current native MiniMax M2.7 PAYG row; high-speed variant is priced separately at 2x input/output.",
  },
  {
    id: "minimax-m2.7-highspeed",
    models: ["minimax-m2.7-highspeed", "minimax/minimax-m2.7-highspeed"],
    canonicalModel: "MiniMax M2.7 Highspeed",
    basis: "MiniMax official PAYG pricing docs, accessed 2026-05-25",
    inputPerMTok: 0.6,
    outputPerMTok: 2.4,
    cacheReadPerMTok: 0.06,
    cacheWritePerMTok: 0.375,
  ...
  },
  {
    ...
    basis: "OpenRouter provider row, accessed 2026-05-25",
    inputPerMTok: 0.15,
    outputPerMTok: 1.15,
    cacheReadPerMTok: 0.03,
    cacheWritePerMTok: 0.15,
    notes: "OpenRouter-routed MiniMax M2.5 row; cache write modeled at routed input rate because OpenRouter exposes cached-input reads, not MiniMax cache writes.",
  },
  {
    ...
    notes: "OpenRouter-routed MiniMax M2 row retained for historical/router usage.",
  },
  {
    ...
    outputPerMTok: 0.95,
    cacheReadPerMTok: 0.03,
    cacheWritePerMTok: 0.29,
    notes: "OpenRouter-routed MiniMax M2.1 row retained for historical/router usage.",
  },
  {
    id: "kimi-k2.6-fire-pass",
    models: ["kimi-k2p6-turbo"],
    canonicalModel: "Kimi K2.6 Turbo (Fire Pass router)",
    basis: "Fireworks Fire Pass docs, accessed 2026-05-25",
    inputPerMTok: 0,
    outputPerMTok: 0,
    cacheReadPerMTok: 0,
    cacheWritePerMTok: 0,
  ...
  },
  {
    ...
    cacheWritePerMTok: 0.75,
    notes: "OpenRouter-routed Kimi K2.6 row; cache write modeled at routed input rate.",
  },
  {
    id: "kimi-k2.6",
    models: ["kimi-k2.6", "kimi-k2p6"],
    canonicalModel: "Kimi K2.6",
    basis: "Fireworks/Moonshot model pricing rows, accessed 2026-05-25",
    inputPerMTok: 0.95,
    outputPerMTok: 4,

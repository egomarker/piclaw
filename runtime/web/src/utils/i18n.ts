...
//   - `ja`    Japanese
//   - `ru`    Russian
// Legacy/loose inputs (`zh`, `zh_cn`, `ja-JP`, `ru-RU`, ...) normalize into the above.

import { getLocalStorageItem, setLocalStorageItem } from './storage.js';
import { useEffect, useState } from '../vendor/preact-htm.js';

export type Locale = 'en' | 'zh-CN' | 'ja' | 'ru';

export const DEFAULT_LOCALE: Locale = 'en';
export const SUPPORTED_LOCALES: readonly Locale[] = ['en', 'zh-CN', 'ja', 'ru'];
...
const RU: Partial<Record<MessageKey, string>> = {
  'compose.placeholder': 'Сообщение (Enter — отправить, Shift+Enter — новая строка)…',
  'compose.send': 'Отправить',
  'compose.stop': 'Стоп',
  'compose.searchPlaceholder': 'Поиск (Enter — выполнить)…',
  'compose.clearAll': 'Очистить всё',
  'compose.clearAllTitle': 'Очистить все вложения и ссылки',
  'compose.scope': 'Область',
  'compose.searchScope': 'Область поиска',
  'compose.scopeCurrent': 'Текущий',
  'compose.scopeBranchFamily': 'Семейство ветвей',
  'compose.scopeAll': 'Все чаты',
  'compose.filterImages': 'Изображения',
  'compose.filterAttachments': 'Вложения',
  'compose.search': 'Поиск',
  'compose.closeSearch': 'Закрыть поиск',
  'compose.shareLocation': 'Поделиться местоположением',
  'compose.attachFile': 'Прикрепить файл',
  'compose.queueControls': 'Управление отложенными ответами',
  'compose.moveUp': 'Вверх',
  'compose.moveUpQueue': 'Поднять в очереди',
  'compose.moveDown': 'Вниз',
  'compose.moveDownQueue': 'Опустить в очереди',
  'compose.editInCompose': 'Редактировать в поле ввода',
  'compose.returnToEditor': 'Вернуть отложенное сообщение в редактор',
  'compose.injectSteer': 'Отправить отложенный ответ как указание',
  'compose.steer': 'Направить',
  'compose.cancelQueued': 'Отменить отложенное сообщение',
  'compose.resizeInput': 'Изменить размер поля ввода',
  'compose.resizeInputHint': 'Перетащите, чтобы изменить размер поля ввода',
  'compose.modelPicker': 'Выбор модели',
  'compose.sessionsAndAgents': 'Сессии и агенты',
  'compose.openModelPicker': 'Открыть выбор модели',
  'compose.newBranchTitle': 'Создать новую ветвь из этого чата',
  'compose.newRootTitle': 'Создать чистую корневую сессию, например web:ops',
  'compose.renameSessionTitle': 'Переименовать текущую сессию',
  'compose.pruneSessionTitle': 'Удалить текущую ветвь агента/сессии',
  'compose.filterImagesTitle': 'Показывать только сообщения с изображениями',
  'compose.filterAttachmentsTitle': 'Показывать только сообщения с вложениями',
  'compose.selectModel': 'Выбрать модель',
  'compose.loadingModels': 'Загрузка моделей…',
  'compose.noModels': 'Нет доступных моделей.',
  'compose.nextModel': 'Следующая модель',
  'compose.manageSessions': 'Управление сессиями и агентами',
  'compose.noSessions': 'Других сессий пока нет.',
  'compose.newBranch': 'Новая ветвь',
  'compose.newRoot': 'Новый корень…',
  'compose.mergeCurrent': 'Объединить с родителем',
  'compose.renameCurrent': 'Переименовать…',
  'compose.deleteCurrent': 'Удалить…',
  'compose.mergeInto': 'Объединить эту ветвь с {target}',
  'compose.mergeBlocked': 'Эту ветвь нельзя объединить, пока она активна или имеет потомков',
  'workspace.title': 'Рабочая область',
  'workspace.moveConfirm': 'Переместить {entry} «{name}»: {source} → {target}?',
  'workspace.root': 'корень рабочей области',
  'workspace.file': 'файл',
  'workspace.folder': 'папку',
  'workspace.newFile': 'Новый файл',
  'workspace.refresh': 'Обновить',
  'workspace.actions': 'Действия рабочей области',
  'workspace.uploadFiles': 'Загрузить файлы',
  'workspace.reindexing': 'Переиндексация рабочей области…',
  'workspace.deleteFile': 'Удалить файл',
  'workspace.download': 'Скачать',
  'workspace.uploadToFolder': 'Загрузить файлы в эту папку',
  'workspace.addFolderHint': 'Добавить папку в поле ввода',
  'workspace.downloadZip': 'Скачать папку в zip',
  'workspace.openInTab': 'Открыть во вкладке',
  'workspace.openInEditor': 'Открыть в редакторе',
  'workspace.renameSelected': 'Переименовать выбранное',
  'workspace.downloadSelectedFile': 'Скачать выбранный файл',
  'workspace.downloadSelectedFolder': 'Скачать выбранную папку (zip)',
  'workspace.deleteSelectedFile': 'Удалить выбранный файл',
  'shell.settings': 'Настройки',
  'shell.newChat': 'Новый чат',
  'shell.connecting': 'Подключение…',
  ...
  'settings.section.recordings': 'Записи',
  'settings.section.compaction': 'Сжатие',
  'settings.section.keyboard': 'Клавиатура',
  'settings.section.workspace': 'Рабочая область',
  'settings.section.environment': 'Окружение',
  'settings.section.providers': 'Провайдеры',
  'settings.section.models': 'Модели',
  'settings.section.theme': 'Внешний вид',
  'settings.section.scheduled-tasks': 'Запланированные задачи',
  'settings.section.quick-actions': 'Быстрые действия',
  'settings.section.keychain': 'Хранилище ключей',
  'settings.section.tools': 'Инструменты',
  'settings.section.addons': 'Дополнения',
  'settings.placeholder.recordings': 'Фильтр записей…',
  'settings.placeholder.keyboard': 'Фильтр сочетаний…',
  'settings.placeholder.environment': 'Фильтр окружения…',
  'settings.placeholder.models': 'Фильтр моделей…',
  'settings.placeholder.scheduled-tasks': 'Фильтр задач…',
  'settings.placeholder.quick-actions': 'Фильтр быстрых действий…',
  'settings.placeholder.keychain': 'Фильтр записей…',
  'settings.placeholder.tools': 'Фильтр инструментов…',
  'settings.placeholder.addons': 'Фильтр дополнений…',
  'preview.close': 'Закрыть',
  'preview.loading': 'Загрузка предпросмотра…',
  'preview.files': 'Файлы',
  'preview.folders': 'Папки',
  'preview.compressed': 'Сжатые',
  'preview.uncompressed': 'Несжатые',
  'preview.name': 'Имя',
  'preview.type': 'Тип',
  'preview.method': 'Метод',
  'preview.size': 'Размер',
  'post.deleteMessage': 'Удалить сообщение',
  'post.tooLarge': 'Сообщение слишком велико для отображения.',
  'post.previewTruncated': 'Предпросмотр обрезан.',
  'post.submitted': 'Отправлено',
  'post.discard': 'Отбросить',
  'post.save': 'Сохранить',
  'post.cancel': 'Отмена',
  'post.addNote': 'Добавить заметку',
  'post.addNotePlaceholder': 'Добавить заметку…',
  'post.restartNotice': 'Перезапуск — причина: {reason}',
  'post.restartCompleted': 'Перезапуск завершён.',
  'post.agentSelfResume': 'Самовозобновление агента',
  'tab.close': 'Закрыть',
  'tab.closeOthers': 'Закрыть остальные',
  'tab.closeAll': 'Закрыть все',
  'tab.reattach': 'Вернуть в окно',
  'tab.openInWindow': 'Открыть в окне',
  'tab.openInNewTab': 'Открыть в новой вкладке',
  'tab.pinned': 'Закреплено',
  'tab.detached': 'Откреплено',
  'tab.openSeparateWindow': 'Открыть в отдельном окне',
  'status.trackedVariables': 'Отслеживаемые переменные',
  'status.attachToSession': 'Прикрепить к сессии',
  'status.files': 'Файлы',
  'status.proposedDiff': 'Предлагаемый diff',
  'status.copyTmux': 'Копировать команду tmux',
  'status.experimentDuration': 'Длительность эксперимента',
  'status.sinceLastActivity': 'С момента последней активности',
  'annotator.title': 'Аннотировать изображение',
  'annotator.typeLabel': 'Введите подпись…',
  'annotator.undo': 'Отменить',
  'annotator.resetZoom': 'Сбросить масштаб',
  'tree.filter': 'Фильтр…',
  'tree.sessionTree': 'Дерево сессий',
  'btw.label': 'Беседа BTW',
  'btw.close': 'Закрыть BTW',
  'btw.thinking': 'Думает…',
  'mdpreview.close': 'Закрыть предпросмотр',
  'mdpreview.unavailable': 'Предпросмотр недоступен',
  'widget.close': 'Закрыть виджет',
  'oobe.gettingStarted': 'Первые шаги',
  'oobe.needsSetupTitle': 'Экземпляр требует настройки',
  'oobe.configuredTitle': 'Экземпляр настроен',
  'oobe.needsSetupBody': 'Этот экземпляр ещё не настроен. Откройте «Настройки» и настройте провайдеров/модели ИИ, чтобы начать отправлять запросы.',
  'oobe.configuredBody': 'Похоже, экземпляр настроен. Проверьте или обновите настройки провайдеров и моделей в «Настройках».',
  'oobe.openSettings': 'Открыть настройки',
  'oobe.dismiss': 'Скрыть',
  'oobe.done': 'Готово',
  'palette.placeholder': 'Начните вводить, чтобы перейти к агенту, действию рабочей области или слэш-команде…',
  'palette.hideWorkspace': 'Скрыть рабочую область',
  'palette.showWorkspace': 'Показать рабочую область',
  'palette.hideWorkspaceDesc': 'Скрыть боковую панель рабочей области.',
  'palette.showWorkspaceDesc': 'Показать боковую панель рабочей области.',
  'palette.exitChatOnly': 'Выйти из режима «только чат»',
  'palette.chatOnly': 'Режим «только чат»',
  'palette.exitChatOnlyDesc': 'Вернуться к разделённому макету с рабочей областью.',
  'palette.chatOnlyDesc': 'Переключиться на макет только с чатом.',
  'palette.groupAgents': 'Агенты',
  'palette.groupWorkspace': 'Рабочая область',
  'palette.groupSlash': 'Слэш-команды',
  'palette.hintMove': 'Переместить',
  'palette.hintSelect': 'Выбрать',
  'palette.hintPopOut': 'Открыть отдельно',
  'palette.hintClose': 'Закрыть',
  'settings.appliedNotice': 'Настройки применены. Изменения вступят в силу со следующего хода.',
  'settings.sessions.lifecycle': 'Жизненный цикл сессий',
  'settings.sessions.autoRotate': 'Автопереключение сессий',
  'settings.sessions.maxSize': 'Макс. размер сессии (МБ)',
  'settings.sessions.maxSizeAria': 'максимальный размер сессии',
  'settings.sessions.agentBehaviour': 'Поведение агента',
  'settings.sessions.toolBudget': 'Бюджет вызовов инструментов',
  'settings.sessions.toolBudgetAria': 'бюджет вызовов инструментов',
  'settings.sessions.toolBudgetHint': 'макс. число выполненных вызовов инструментов за ход',
  'settings.sessions.isolation': 'Изоляция сессий',
  'settings.sessions.isolationNone': 'Нет — полная видимость между сессиями',
  'settings.sessions.isolationSummary': 'Сводка — инструменты видны, аргументы скрыты',
  'settings.sessions.isolationFull': 'Полная — сессии не видят друг друга',
  'settings.editor.heading': 'Редактор',
  'settings.editor.vimMode': 'Режим Vim',
  'settings.editor.showWhitespace': 'Показывать пробелы',
  'settings.editor.livePreview': 'Предпросмотр Markdown в реальном времени',
  'settings.editor.fontSize': 'Размер шрифта (px)',
  'settings.editor.fontSizeAria': 'размер шрифта редактора',
  'settings.editor.fontFamily': 'Семейство шрифта',
  'settings.editor.fontFamilyPlaceholder': 'моноширинный (по умолчанию)',
  'settings.editor.localOnlyHint': 'Только в этом браузере. Изменения редактора хранятся в локальном хранилище браузера и применяются при следующем открытии или перезагрузке вкладки с файлом.',
  'settings.appearance.syncing': 'Синхронизация оформления…',
  'settings.appearance.default': 'По умолчанию',
  'settings.appearance.autoLightDark': 'авто (светлая/тёмная)',
  'settings.appearance.tint': 'Оттенок:',
  'settings.appearance.clearTint': 'Убрать оттенок',
  'settings.appearance.none': 'нет',
  'settings.appearance.outputPadding': 'Отступ вывода',
  'settings.appearance.outputPaddingHint': 'Дополнительное пространство вокруг сообщений и панелей размышлений.',
  'settings.keyboard.heading': 'Клавиатура',
  'settings.keyboard.hint1': 'Настройте общие для приложения сочетания клавиш, разделяя их запятыми. Изменения применяются сразу.',
  'settings.keyboard.hint1b': 'зарезервирована для отмены/прерывания и не может быть переназначена.',
  'settings.keyboard.hint2mid': 'и набор',
  'settings.keyboard.hint2end': 'вне поля ввода открывают эту панель.',
  'settings.keyboard.resetAll': 'Сбросить все к значениям по умолчанию',
  'settings.keyboard.defaultColon': 'По умолчанию:',
  'settings.keyboard.save': 'Сохранить',
  'settings.keyboard.defaultBtn': 'По умолчанию',
  'settings.keyboard.noMatch': 'Ни одно сочетание не соответствует фильтру.',
  'settings.keyboard.invalidShortcut': 'Недопустимое сочетание: {token}. Клавиша Escape зарезервирована и не может быть переназначена.',
  'settings.keyboard.saved': 'Сочетания клавиш сохранены.',
  'settings.keyboard.resetOne': 'Сочетание клавиш сброшено к значению по умолчанию.',
  'settings.keyboard.resetAllDone': 'Сочетания клавиш сброшены к значениям по умолчанию.',
  'settings.workspace.serverApplied': 'Настройки рабочей области применены. Серверные ограничения действуют для новых запросов к рабочей области сразу.',
  'settings.workspace.browserApplied': 'Настройки рабочей области для браузера применены в этой вкладке.',
  'settings.workspace.access': 'Доступ',
  'settings.workspace.enableTerminal': 'Включить веб-терминал',
  'settings.workspace.allowVnc': 'Разрешить прямые VNC-цели',
  'settings.workspace.accessHint': 'Доступ к терминалу обновляется сразу. Политика прямых VNC-целей применяется к новым VNC-запросам.',
  'settings.workspace.guardrails': 'Ограничения сканирования на сервере',
  'settings.workspace.maxDepth': 'Максимальная глубина дерева',
  'settings.workspace.maxDepthAria': 'максимальная глубина дерева рабочей области',
  'settings.workspace.maxDepthHintPre': 'ограничивает все',
  'settings.workspace.maxDepthHintPost': 'запросы',
  'settings.workspace.maxEntries': 'Макс. число записей за сканирование',
  'settings.workspace.maxEntriesAria': 'максимальное число записей дерева',
  'settings.workspace.maxEntriesHint': 'обрезает слишком большие обходы дерева раньше',
  'settings.workspace.thisBrowser': 'Этот браузер',
  'settings.workspace.refreshInterval': 'Интервал обновления (секунды)',
  'settings.workspace.refreshIntervalAria': 'интервал обновления рабочей области',
  'settings.workspace.folderDepth': 'Глубина сканирования предпросмотра папок',
  'settings.workspace.folderDepthAria': 'глубина сканирования предпросмотра папок',
  'settings.workspace.folderDepthHintPre': 'равное',
  'settings.workspace.folderDepthHintPost': 'отключает предпросмотр размера папок',
  'settings.workspace.footerHint': 'Загрузки корня и развёртывания папок остаются неглубокими; предпросмотр размера папок — самое глубокое сканирование в интерфейсе.',
  'settings.models.thinkingLevel': 'Уровень размышлений',
  'settings.models.noThinking': 'Текущая модель не поддерживает размышления.',
  'settings.models.thinkingLevelLabel': 'Уровень размышлений:',
  'settings.models.loading': 'Загрузка моделей…',
  'settings.models.summary': 'Названия моделей и провайдеров могут переноситься в узких панелях, чтобы не обрезаться.',
  'settings.models.scopedOnly': 'Только заданные модели',
  'settings.models.scopedCheckboxPre': 'Использовать Pi',
  'settings.models.scopedCheckboxPost': 'для списков моделей Piclaw',
  'settings.models.scopedHintPre': 'Фильтрует этот выбор и инструмент',
  'settings.models.scopedHintPost': '. Выбор моделей в TUI не меняется.',
  'settings.models.colModel': 'Модель',
  'settings.models.colProvider': 'Провайдер',
  'settings.models.colContext': 'Контекст',
  'settings.models.colReasoning': 'Рассуждение',
  'settings.models.noMatch': 'Нет моделей, соответствующих «{filter}»',
  'settings.tools.unavailable': 'Данные об инструментах недоступны.',
  'settings.tools.search': 'Поиск',
  'settings.tools.matchMode': 'Режим сопоставления',
  'settings.tools.orMode': 'Любое ключевое слово (ИЛИ) — результат совпадает хотя бы с одним условием поиска',
  'settings.tools.andMode': 'Все ключевые слова (И) — результат должен совпадать с каждым условием поиска',
  'settings.tools.colEnabled': 'Включён',
  'settings.tools.colTool': 'Инструмент',
  'settings.tools.colCompact': 'Сжатие результатов',
  'settings.tools.colKind': 'Тип',
  'settings.tools.colSummary': 'Сводка',
  'settings.tools.colSource': 'Источник',
  'settings.tools.disableCompaction': 'Отключить сжатие результатов для этого инструмента',
  'settings.tools.enableCompaction': 'Включить сжатие результатов для этого инструмента',
  'settings.tools.noMatch': 'Нет инструментов, соответствующих «{filter}»',
  'settings.tools.footer': 'Активацией инструментов управляет среда агента. Флажки групп сворачивают/разворачивают списки; колонка «Сжатие» управляет допустимостью сжатия результатов инструментов.',
  'settings.environment.heading': 'Окружение',
  'settings.environment.introPre': 'Показаны только переменные окружения, не из хранилища ключей. Переопределения хранятся в KV расширений и применяются к',
  'settings.environment.introPost': ', поэтому последующие вызовы инструментов их наследуют.',
  'settings.environment.refresh': 'Обновить',
  'settings.environment.addOverride': 'Добавить переопределение',
  'settings.environment.valuePlaceholder': 'значение',
  'settings.environment.save': 'Сохранить',
  'settings.environment.countLine': 'Видно переменных: {count} • активно переопределений: {overrides} • скрыто из хранилища ключей: {keychain}',
  'settings.environment.overridden': 'Переопределено в KV',
  'settings.environment.inherited': 'Наследуется из окружения процесса',
  'settings.environment.kindOverride': 'переопределение',
  'settings.environment.kindProcess': 'процесс',
  'settings.environment.clear': 'Очистить',
  'settings.environment.noMatch': 'Нет переменных окружения, соответствующих «{filter}».',
  'settings.environment.refreshedToast': 'Окружение обновлено.',
  'settings.environment.savedToast': 'Сохранено переопределение окружения для {name}.',
  'settings.environment.clearedToast': 'Удалено переопределение окружения для {name}.',
  'settings.quickActions.loading': 'Загрузка…',
  'settings.quickActions.heading': 'Быстрые действия в ленте',
  'settings.quickActions.intro': 'Выберите, какие действия показывать в автодополнении ленты. Сначала всегда агенты, затем команды рабочей области, затем слэш-команды.',
  'settings.quickActions.enableAll': 'Включить все',
  'settings.quickActions.saving': 'Сохранение…',
  'settings.quickActions.saveApply': 'Сохранить и применить',
  'settings.quickActions.workspaceCommands': 'Команды рабочей области',
  'settings.quickActions.noWorkspaceMatch': 'Нет команд рабочей области, соответствующих фильтру.',
  'settings.quickActions.slashCommands': 'Слэш-команды',
  'settings.quickActions.slashFallback': 'слэш-команда',
  'settings.quickActions.noSlashMatch': 'Нет слэш-команд, соответствующих фильтру.',
  'settings.quickActions.savingToast': 'Сохранение быстрых действий…',
  'settings.quickActions.savedToast': 'Быстрые действия сохранены.',
  'settings.providers.authApiKey': 'API-ключ',
  'settings.providers.authConfigured': 'Настроено',
  'settings.providers.heading': 'Провайдеры',
  'settings.providers.tagCustom': 'Пользовательский',
  'settings.providers.logout': 'Выйти',
  'settings.providers.reconfigure': 'Перенастроить',
  'settings.providers.setUp': 'Настроить',
  'settings.providers.setupHint': 'Потоки входа открываются в браузере. В узких панелях форма настройки складывается вертикально, чтобы не обрезаться.',
  'settings.providers.starting': 'Запуск…',
  'settings.providers.signInOAuth': 'Войти через OAuth',
  'settings.providers.apiKeyLabel': 'API-ключ',
  'settings.providers.apiKeyPlaceholder': 'Введите API-ключ',
  'settings.providers.save': 'Сохранить',
  'settings.providers.configuring': 'Настройка…',
  'settings.providers.saveConfig': 'Сохранить конфигурацию',
  'settings.providers.apiKeyEmpty': 'API-ключ не может быть пустым.',
  'settings.providers.configuringToast': 'Настройка {provider}…',
  'settings.providers.configured': '{provider} настроен.',
  'settings.providers.startingOAuth': 'Запуск OAuth для {provider}…',
  'settings.providers.oauthOpened': 'Открыто окно OAuth. Завершите вход и закройте это сообщение.',
  'settings.providers.oauthStarted': 'Запущен поток OAuth для {provider}. Проверьте чат.',
  'settings.providers.loggingOut': 'Выход из {provider}…',
  'settings.providers.loggedOut': 'Выполнен выход из {provider}. Возможно, потребуется перезапуск.',
  'settings.general.identity': 'Личность',
  'settings.general.userLabel': 'Пользователь',
  'settings.general.yourName': 'Ваше имя',
  'settings.general.agentLabel': 'Агент',
  'settings.general.agentName': 'Имя агента',
  'settings.general.notifications': 'Уведомления',
  'settings.general.browserNotifications': 'Уведомления браузера',
  'settings.general.notifSecureHint': 'Используйте кнопку 🔔 в панели ввода, чтобы включить/отключить уведомления. Web Push требует HTTPS или localhost.',
  'settings.general.notifInsecureHint': '⚠ Недоступно — требуется защищённый контекст (HTTPS или localhost). Откройте доступ через SSH-туннель или обратный прокси с TLS.',
  'settings.general.display': 'Отображение',
  'settings.general.systemMeters': 'Системные индикаторы',
  'settings.general.systemMetersHint': 'Индикаторы CPU/памяти/сети в строке состояния. Только в этом браузере.',
  'settings.general.instanceConfig': 'Конфигурация экземпляра',
  'settings.general.composeUpload': 'Загрузка в поле ввода (МБ)',
  'settings.general.composeUploadAria': 'лимит загрузки в поле ввода',
  'settings.general.composeUploadHint': 'вложения чата/медиа',
  'settings.general.workspaceUpload': 'Загрузка в рабочую область (МБ)',
  'settings.general.workspaceUploadAria': 'лимит загрузки в рабочую область',
  'settings.general.workspaceUploadHint': 'по умолчанию 256 МБ; поэтапная загрузка до 1 ГБ',
  'settings.general.agentRecovery': 'Дополнительно · Восстановление агента',
  'settings.general.automaticRecovery': 'Автоматическое восстановление',
  'settings.general.automaticRecoveryHint': 'Автоматически повторять исправимые неудачные ходы.',
  'settings.general.recoveryMaxAttempts': 'Максимум попыток',
  'settings.general.recoveryMaxAttemptsAria': 'максимум попыток автоматического восстановления',
  'settings.general.recoveryMaxAttemptsHint': '0 — обычный лимит повторов.',
  'settings.general.recoveryTotalBudget': 'Общий бюджет (мс)',
  'settings.general.recoveryTotalBudgetAria': 'общий бюджет автоматического восстановления в миллисекундах',
  'settings.general.recoveryTotalBudgetHint': 'Ограничивает всю работу автоматического восстановления за один ход.',
  'settings.general.authentication': 'Аутентификация',
  'settings.general.widgetToken': 'Bearer-токен виджета',
  'settings.general.token': 'Токен',
  'settings.general.hideToken': 'Скрыть токен',
  'settings.general.revealToken': 'Показать токен',
  'settings.general.copyToken': 'Копировать токен',
  'settings.general.copied': 'Скопировано',
  'settings.general.regenerating': 'Перегенерация…',
  'settings.general.regenerate': 'Перегенерировать',
  'settings.general.tokenHintPre': 'Токен только для чтения для',
  'settings.general.tokenHintMid': 'и',
  'settings.general.tokenHintPost': '. Используйте как',
  'settings.general.tokenHintEnd': '.',
  'settings.general.copyFailed': 'Не удалось скопировать токен виджета. Выделите поле токена и скопируйте вручную.',
  'settings.general.regenConfirm': 'Перегенерировать токен виджета? Существующие виджеты macOS со старым токеном перестанут обновляться.',
  'settings.general.totpTitle': 'QR-код настройки TOTP',
  'settings.general.totpConfiguredHint': 'Текущий секрет аутентификатора веб-входа. Отсканируйте QR, чтобы добавить ещё одно устройство.',
  'settings.general.totpUnconfiguredHint': 'TOTP ещё не настроен для этого экземпляра, поэтому QR для настройки недоступен.',
  'settings.general.issuer': 'Эмитент',
  'settings.general.label': 'Метка',
  'settings.general.secret': 'Секрет',
  'settings.general.avatarUpload': 'Нажмите, чтобы загрузить',
  'settings.developer.heading': 'Разработка',
  'settings.developer.devMode': 'Режим разработчика',
  'settings.developer.localHint': 'Только в этом браузере. Переключатели режима разработчика и переопределения каталога дополнений хранятся в локальном хранилище браузера.',
  'settings.developer.addonSources': 'Источники дополнений',
  'settings.developer.catalogUrl': 'URL каталога',
  'settings.developer.catalogHint': 'Основной URL каталога дополнений. Оставьте пустым, чтобы использовать по умолчанию',
  'settings.developer.additionalCatalogs': 'Дополнительные URL каталогов',
  'settings.developer.additionalHint': 'Загружаются дополнительно к основному каталогу. Один URL на строку.',
  'settings.developer.repoUrl': 'URL репозитория',
  'settings.developer.repoHintPre': 'Переопределить git-репозиторий, используемый для',
  'settings.developer.repoHintPost': 'установок. Оставьте пустым для значения по умолчанию.',
  'settings.developer.debug': 'Отладка',
  'settings.developer.logSse': 'Записывать события SSE',
  'settings.developer.logToolCalls': 'Записывать вызовы инструментов',
  'settings.developer.debugHint': 'Флаги отладки применяются при следующей перезагрузке страницы.',
  'settings.addons.installing': 'Установка {slug}…',
  'settings.addons.removing': 'Удаление {slug}…',
  'settings.addons.installedToast': 'Дополнение установлено.',
  'settings.addons.removedToast': 'Дополнение удалено.',
  'settings.addons.restarting': 'Перезапуск piclaw…',
  'settings.addons.restartComplete': 'Перезапуск завершён — дополнения обновлены.',
  'settings.addons.restartTimeout': 'Бэкенд не ответил вовремя. Перезагрузите страницу вручную.',
  'settings.addons.fetching': 'Загрузка дополнений…',
  'settings.addons.loadFailed': 'Не удалось загрузить дополнения.',
  'settings.addons.catalogFromPre': 'Каталог из',
  'settings.addons.catalogMerged': 'Объединено источников каталога: {count}.',
  'settings.addons.installNote': 'Установка пакетом через Bun; после установки/удаления требуется перезапуск.',
  'settings.addons.failedFetchSingular': 'Не удалось получить {count} источник каталога:',
  'settings.addons.failedFetchPlural': 'Не удалось получить {count} источников каталога:',
  'settings.addons.activeSources': 'Активные источники каталога ({count})',
  'settings.addons.windowsWarning': 'Нативные установки дополнений в Windows рискованнее: установка пакетов Bun, очистка символьных ссылок, заблокированные файлы и время перезапуска менее предсказуемы, чем в Linux/WSL. Предпочтительно WSL или контейнер.',
  'settings.addons.typeExtSkill': 'расширение + навык',
  'settings.addons.typeSkill': 'навык',
  'settings.addons.typeExt': 'расширение',
  'settings.addons.update': 'Обновить',
  'settings.addons.remove': 'Удалить',
  'settings.addons.install': 'Установить',
  'settings.addons.noMatch': 'Нет дополнений, соответствующих «{filter}»',
  'settings.addons.restartNotice': 'Изменения расширений установлены, но неактивны до перезапуска piclaw.',
  'settings.addons.restartNow': 'Перезапустить сейчас',
  'settings.recordings.modeFull': 'полная / доверенная',
  'settings.recordings.modeMetadata': 'только метаданные',
  'settings.recordings.modeRedacted': 'с маскированием',
  'settings.recordings.selectPrompt': 'Выберите запись для просмотра, воспроизведения, экспорта или удаления.',
  'settings.recordings.playback': 'Воспроизведение',
  'settings.recordings.refresh': 'Обновить',
  'settings.recordings.delete': 'Удалить',
  'settings.recordings.status': 'Статус',
  'settings.recordings.mode': 'Режим',
  'settings.recordings.chat': 'Чат',
  'settings.recordings.started': 'Начата',
  'settings.recordings.ended': 'Завершена',
  'settings.recordings.events': 'События',
  'settings.recordings.redactions': 'Маскирование',
  'settings.recordings.exportJson': 'Экспорт JSON',
  'settings.recordings.exportJsonl': 'Экспорт JSONL',
  'settings.recordings.exportHtml': 'Экспорт в автономный HTML',
  'settings.recordings.eventSummary': 'Сводка событий',
  'settings.recordings.inspectHint': 'Откройте или обновите детали, чтобы просмотреть события трассировки.',
  'settings.recordings.firstEvents': 'Первые события',
  'settings.recordings.heading': 'Запись сессии',
  'settings.recordings.intro': 'Опциональный захват трассировки для детерминированного воспроизведения и экспорта как записи экрана. Воспроизведение никогда не вызывает живые конечные точки агента или инструментов.',
  'settings.recordings.chatJid': 'JID чата',
  'settings.recordings.title': 'Название',
  'settings.recordings.titlePlaceholder': 'Демо-запись',
  'settings.recordings.modeLabelField': 'Режим',
  'settings.recordings.optRedacted': 'С маскированием',
  'settings.recordings.optMetadata': 'Только метаданные',
  'settings.recordings.optFull': 'Полная / доверенная локально',
  'settings.recordings.includeSnapshot': 'Включить снимок ленты',
  'settings.recordings.extraKeys': 'Дополнительные маскируемые ключи',
  'settings.recordings.extraPatterns': 'Дополнительные regex-шаблоны',
  'settings.recordings.stopCurrent': 'Остановить запись текущего чата',
  'settings.recordings.start': 'Начать запись',
  'settings.recordings.redactionPreview': 'Предпросмотр маскирования',
  'settings.recordings.previewRedaction': 'Показать маскирование',
  'settings.recordings.loading': 'Загрузка записей…',
  'settings.recordings.noneYet': 'Записей пока нет.',
  'settings.recordings.noneYetHint': 'Начните запись выше, затем используйте воспроизведение/экспорт для детерминированного захвата экрана.',
  'settings.recordings.listLabel': 'Записи сессий',
  'settings.recordings.eventsCount': 'Событий: {count}',
  'settings.recordings.noMatch': 'Нет записей, соответствующих «{filter}».',
  'settings.recordings.startedToast': 'Запись начата для {chat}.',
  'settings.recordings.startFailed': 'Не удалось начать запись.',
  'settings.recordings.stoppedToast': 'Запись остановлена для {chat}.',
  'settings.recordings.stopFailed': 'Не удалось остановить запись.',
  'settings.recordings.deleteConfirm': 'Удалить запись {id}?',
  'settings.recordings.deletedToast': 'Запись удалена.',
  'settings.recordings.deleteFailed': 'Не удалось удалить запись.',
  'settings.recordings.loadOneFailed': 'Не удалось загрузить запись.',
  'settings.recordings.loadFailed': 'Не удалось загрузить записи.',
  'settings.recordings.previewFailed': 'Не удалось показать предпросмотр.',
  'settings.keychain.loadFailed': 'Не удалось загрузить хранилище ключей.',
  'settings.keychain.addFailed': 'Не удалось добавить запись.',
  'settings.keychain.deleteFailed': 'Не удалось удалить запись.',
  'settings.keychain.saveNotesFailed': 'Не удалось сохранить заметки.',
  'settings.keychain.revealFailed': 'Не удалось показать.',
  'settings.keychain.loading': 'Загрузка хранилища ключей…',
  'settings.keychain.entryCountSingular': '{count} запись',
  'settings.keychain.entryCountPlural': '{count} записей',
  'settings.keychain.matchingFilter': ', совпадает с «{filter}»',
  'settings.keychain.encryptedSuffix': ', зашифровано при хранении.',
  'settings.keychain.clickPrefix': 'Нажмите',
  'settings.keychain.revealSuffix': ', чтобы показать.',
  'settings.keychain.cancel': 'Отмена',
  'settings.keychain.addEntry': '+ Добавить запись',
  'settings.keychain.namePlaceholder': 'Имя записи (например, github/my-token)',
  'settings.keychain.secretPlaceholder': 'Значение секрета',
  'settings.keychain.usernamePlaceholder': 'Имя пользователя (необязательно)',
  'settings.keychain.saving': 'Сохранение…',
  'settings.keychain.save': 'Сохранить',
  'settings.keychain.userNotePlaceholder': 'Заметка пользователя (видна только в этом интерфейсе)',
  'settings.keychain.agentNotePlaceholder': 'Заметка для агента (безопасно показывать агентам)',
  'settings.keychain.noMatchFilter': 'Нет записей, соответствующих фильтру.',
  'settings.keychain.noEntries': 'В хранилище ключей нет записей.',
  'settings.keychain.hideSecret': 'Скрыть секрет',
  'settings.keychain.revealSecret': 'Показать секрет',
  'settings.keychain.deleteQ': 'Удалить?',
  'settings.keychain.yes': 'Да',
  'settings.keychain.no': 'Нет',
  'settings.keychain.deleteTitle': 'Удалить',
  'settings.keychain.userNote': 'Заметка пользователя',
  'settings.keychain.agentNote': 'Заметка для агента',
  'settings.keychain.userNoteHint': 'Только для человека/интерфейса',
  'settings.keychain.agentNoteHint': 'Безопасные указания для агентов',
  'settings.keychain.saveNotes': 'Сохранить заметки',
  'settings.keychain.masterPassword': 'Мастер-пароль:',
  'settings.keychain.masterPasswordPlaceholder': 'Введите мастер-пароль хранилища ключей',
  'settings.keychain.unlock': 'Разблокировать',
  'settings.keychain.totpCode': 'Код TOTP:',
  'settings.keychain.verify': 'Проверить',
  'settings.keychain.username': 'Имя пользователя',
  'settings.keychain.copyUsername': 'Копировать имя пользователя',
  'settings.keychain.secret': 'Секрет',
  'settings.keychain.copySecret': 'Копировать секрет',
  'settings.tasks.internalProtected': 'внутренняя/защищённая',
  'settings.tasks.noRunLogs': 'Журналов запусков пока нет.',
  'settings.tasks.noSummary': 'Нет сводки',
  'settings.tasks.selectPrompt': 'Выберите задачу, чтобы посмотреть расписание, статус и историю запусков.',
  'settings.tasks.pause': 'Пауза',
  'settings.tasks.resume': 'Возобновить',
  'settings.tasks.delete': 'Удалить',
  'settings.tasks.status': 'Статус',
  'settings.tasks.kind': 'Тип',
  'settings.tasks.schedule': 'Расписание',
  'settings.tasks.nextRun': 'Следующий запуск',
  'settings.tasks.lastRun': 'Последний запуск',
  'settings.tasks.lastResult': 'Последний результат',
  'settings.tasks.chat': 'Чат',
  'settings.tasks.model': 'Модель',
  'settings.tasks.cwd': 'CWD',
  'settings.tasks.timeout': 'Тайм-аут',
  'settings.tasks.protection': 'Защита',
  'settings.tasks.protectionHint': 'Действия с внутренними задачами требуют явного подтверждения.',
  'settings.tasks.command': 'Команда',
  'settings.tasks.prompt': 'Промпт',
  'settings.tasks.recentRuns': 'Недавние запуски',
  'settings.tasks.activeLabel': 'Активна',
  'settings.tasks.pausedLabel': 'На паузе',
  'settings.tasks.completedLabel': 'Завершена',
  'settings.tasks.allStatuses': 'Все статусы',
  'settings.tasks.filterChatPlaceholder': 'Фильтр по JID чата…',
  'settings.tasks.refresh': 'Обновить',
  'settings.tasks.loading': 'Загрузка запланированных задач…',
  'settings.tasks.noneFound': 'Запланированных задач не найдено.',
  'settings.tasks.noneFoundHint': 'Задачи, созданные с помощью напоминаний, `/tasks` или инструмента планировщика, появятся здесь.',
  'settings.tasks.listLabel': 'Запланированные задачи',
  'settings.tasks.next': 'Следующая',
  'settings.tasks.last': 'Последняя',
  'settings.tasks.noMatch': 'Нет задач, соответствующих «{filter}».',
  'settings.tasks.confirmDelete': 'Удалить запланированную задачу {id}?',
  'settings.tasks.confirmPause': 'Приостановить запланированную задачу {id}?',
  'settings.tasks.confirmResume': 'Возобновить запланированную задачу {id}?',
  'settings.tasks.confirmProtected': 'Задача {id} внутренняя/защищённая. Продолжить с действием «{action}»?',
  'settings.tasks.deleting': 'Удаление {id}…',
  'settings.tasks.pausing': 'Пауза {id}…',
  'settings.tasks.resuming': 'Возобновление {id}…',
  'settings.tasks.deletedToast': 'Запланированная задача {id} удалена.',
  'settings.tasks.pausedToast': 'Запланированная задача {id} приостановлена.',
  'settings.tasks.resumedToast': 'Запланированная задача {id} возобновлена.',
  'settings.tasks.actionFailed': 'Не удалось выполнить действие {action} для задачи.',
  'settings.tasks.loadFailed': 'Не удалось загрузить запланированные задачи.',
  'settings.compaction.appliedNotice': 'Настройки сжатия применены. Текущие ходы сохраняют свои таймеры; новые ходы используют обновлённые значения.',
  'settings.compaction.saving': 'Сохранение настроек сжатия…',
  'settings.compaction.saveFailed': 'Не удалось сохранить настройки сжатия.',
  'settings.compaction.saved': 'Настройки сжатия сохранены.',
  'settings.compaction.clearing': 'Сброс подавления сжатия для {chat}…',
  'settings.compaction.clearFailed': 'Не удалось сбросить подавление сжатия.',
  'settings.compaction.cleared': 'Подавление сжатия сброшено для {chat}.',
  'settings.compaction.autoHeading': 'Автоматическое сжатие',
  'settings.compaction.enableAutomatic': 'Включить автоматическое сжатие',
  'settings.compaction.enableAutomaticHint': 'Сжатие перед промптом/в простое под управлением Piclaw. Встроенный автосжиматель агента остаётся отключённым внутри.',
  'settings.compaction.processingMethod': 'Метод обработки',
  'settings.compaction.methodSelective': 'Выборочный',
  'settings.compaction.methodSelectiveHint': 'Извлекает ценные фрагменты непрерывности, используя полное прогрессивное покрытие, когда ограниченный промпт не может представить все отброшенные события источника.',
  'settings.compaction.methodPipelined': 'Конвейерный',
  'settings.compaction.methodPipelinedHint': 'Канонизирует и классифицирует каждое отброшенное событие источника с проверяемым журналом покрытия перед составлением сводки.',
  'settings.compaction.remoteNative': 'Нативное сжатие на стороне провайдера',
  'settings.compaction.remoteNativeHint': 'Опционально, только для явно поддерживаемых провайдеров ({providers}). Любой сбой атомарно переключается на выбранный локальный метод.',
  'settings.compaction.remoteTimeout': 'Тайм-аут нативного сжатия (сек)',
  'settings.compaction.remoteTimeoutAria': 'тайм-аут нативного сжатия у провайдера',
  'settings.compaction.remoteTimeoutHint': 'Крайний срок удалённого предварительного прохода до локального запасного варианта.',
  'settings.compaction.enableToolResult': 'Включить сжатие результатов инструментов',
  'settings.compaction.enableToolResultHint': 'Если выключено, крупные результаты инструментов остаются встроенными и не выносятся в отдельные доступные для поиска журналы вывода.',
  'settings.compaction.semanticSummaries': 'Семантические сводки для сжатых результатов инструментов',
  'settings.compaction.semanticSummariesHint': 'Если включено, сжатые результаты включают семантическую сводку, созданную активной моделью (при сбое — запасной вариант в виде предпросмотра).',
  'settings.compaction.inputLimit': 'Лимит входных символов семантической сводки',
  'settings.compaction.inputLimitAria': 'лимит входных символов семантической сводки',
  'settings.compaction.inputLimitHint': 'Максимум символов, выбираемых из полного вывода инструмента для семантической сводки.',
  'settings.compaction.maxTokens': 'Максимум токенов вывода семантической сводки',
  'settings.compaction.maxTokensAria': 'максимум токенов семантической сводки',
  'settings.compaction.maxTokensHint': 'Верхняя граница длины создаваемой сводки.',
  'settings.compaction.summaryTimeout': 'Тайм-аут семантической сводки (сек)',
  'settings.compaction.summaryTimeoutAria': 'тайм-аут семантической сводки',
  'settings.compaction.summaryTimeoutHint': 'Прерывает создание семантической сводки после этого тайм-аута и переключается на предпросмотрное сжатие.',
  'settings.compaction.threshold': 'Порог сжатия (%)',
  'settings.compaction.thresholdAria': 'порог сжатия',
  'settings.compaction.thresholdHint': 'автосжатие, когда контекст превышает этот % окна',
  'settings.compaction.timeout': 'Тайм-аут сжатия (сек)',
  'settings.compaction.timeoutAria': 'тайм-аут сжатия',
  'settings.compaction.timeoutHint': 'Прерывает зависшее сжатие перед промптом/вручную, вместо бесконечного ожидания.',
  'settings.compaction.backoffBase': 'Базовая пауза после сбоя (мин)',
  'settings.compaction.backoffBaseAria': 'базовая пауза после сбоя',
  'settings.compaction.backoffBaseHint': 'Первое окно подавления после сбоя сжатия.',
  'settings.compaction.backoffMax': 'Максимальная пауза после сбоя (мин)',
  'settings.compaction.backoffMaxAria': 'максимальная пауза после сбоя',
  'settings.compaction.backoffMaxHint': 'Верхняя граница экспоненциального подавления после повторных сбоев.',
  'settings.compaction.decayFactor': 'Коэффициент затухания паузы',
  'settings.compaction.decayFactorAria': 'коэффициент затухания паузы',
  'settings.compaction.decayFactorHint': '% — вдвое уменьшает паузу после каждого успешного сжатия',
  'settings.compaction.watchdogHeading': 'Сторожевой таймер зависаний',
  'settings.compaction.enableWatchdog': 'Включить сторожевой таймер',
  'settings.compaction.enableWatchdogHint': 'По умолчанию выключен. Если включён, вспомогательный процесс завершает piclaw, когда активная фаза перестаёт посылать пульс.',
  'settings.compaction.watchdogTimeout': 'Тайм-аут сторожевого таймера (сек)',
  'settings.compaction.watchdogTimeoutAria': 'тайм-аут сторожевого таймера',
  'settings.compaction.watchdogTimeoutHint': 'Как долго активная фаза может работать без пульса, прежде чем сторожевой таймер завершит piclaw.',
  'settings.compaction.suppressionsHeading': 'Активные подавления сжатия',
  'settings.compaction.noBackoff': 'Сейчас ни один чат не находится в паузе после сбоя.',
  'settings.compaction.clear': 'Очистить',
  'settings.compaction.phasesHeading': 'Активные фазы сторожевого таймера',
  'settings.compaction.noPhases': 'Сейчас нет отслеживаемых активных фаз.',
  'menu.title': 'Меню',
  'menu.showWorkspace': 'Показать рабочую область',
  'menu.hideWorkspace': 'Скрыть рабочую область',
  'menu.openExplorer': 'Открыть проводник',
  'menu.chatOnly': 'Режим «только чат»',
  'menu.exitChatOnly': 'Выйти из режима «только чат»',
  'menu.openTerminal': 'Открыть терминал во вкладке',
  'menu.openVnc': 'Открыть VNC во вкладке',
  'menu.newFile': 'Новый файл',
  'menu.openRecent': 'Недавние',
  'menu.refreshTree': 'Обновить дерево',
  'menu.reindex': 'Переиндексировать рабочую область',
  'menu.showHidden': 'Показывать скрытые файлы',
  'menu.hideHidden': 'Скрыть скрытые файлы',
  'menu.scale': 'Масштаб',

...
const RU: Partial<Record<MessageKey, string>> = {
  ...
  'compose.injectSteer': 'Отправить отложенный ответ сейчас',
  'compose.steer': 'Отправить сейчас',
  ...
  'settings.section.keychain': 'Связка ключей',
  ...
  'settings.models.thinkingLevel': 'Уровень рассуждений',
  'settings.models.noThinking': 'Текущая модель не поддерживает рассуждения.',
  'settings.models.thinkingLevelLabel': 'Уровень рассуждений:',
  ...
  'settings.environment.introPre': 'Показаны только переменные окружения, не из связки ключей. Переопределения хранятся в KV расширений и применяются к',
  ...
  'settings.environment.countLine': 'Видно переменных: {count} • активно переопределений: {overrides} • скрыто из связки ключей: {keychain}',
  ...
  'settings.recordings.modeRedacted': 'скрыто',
  ...
  'settings.recordings.redactions': 'Скрытие',
  ...
  'settings.recordings.optRedacted': 'Скрыто',
  ...
  'settings.recordings.extraKeys': 'Дополнительные скрываемые ключи',
  ...
  'settings.recordings.redactionPreview': 'Предпросмотр скрытия',
  'settings.recordings.previewRedaction': 'Показать скрытие',
  ...
  'settings.keychain.loadFailed': 'Не удалось загрузить связку ключей.',
  ...
  'settings.keychain.loading': 'Загрузка связки ключей…',
  ...
  'settings.keychain.noEntries': 'В связке ключей нет записей.',
  ...
  'settings.keychain.masterPasswordPlaceholder': 'Введите мастер-пароль связки ключей',

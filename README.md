...
| `PICLAW_WEB_UI_MODE` | `mobile` | Deprecated environment alias for `domains.web.uiMode`; Mobile is the only shell; legacy `classic` and `visual` values are accepted but ignored. |
